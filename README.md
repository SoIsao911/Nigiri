...
- **DCP Cost Optimization** — Detects over-supplied DCP (>115%) and calculates savings per batch
...
1. Enter formulation data (Production mode: resins in kg, additives in g)
1. Click **Calculate & Predict**
1. Review results: Quality Score, CI Status, Expansion, Warnings, Suggestions
1. Use **Formula Wizard** for reverse calculation from target expansion
1. Use **Batch Analysis** for multi-record analysis from History or imported data
